# Personal ostree image based on ublue-os/kinoite-nvidia

[![build](https://github.com/0ranki/sliverblue/actions/workflows/build.yml/badge.svg)](https://github.com/0ranki/sliverblue/actions/workflows/build.yml)
